...
> A bug fix that ensures the "Braid of Atlas" keepsake correctly buffs Cast abilities.

## Features

- Fixes a bug where the Braid of Atlas was not applying its damage bonus to Cast projectiles.
- Ensures that your Cast abilities receive the intended damage increase from the keepsake.
